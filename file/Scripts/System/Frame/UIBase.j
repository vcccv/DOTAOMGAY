...
globals
        ...
        // 键盘 KANA 键，仅用于日语键盘
        constant integer OSKEY_KANA = ($15)
        // 键盘 HANGUL 键，仅用于朝鲜/韩语键盘
        constant integer OSKEY_HANGUL = ($15)
        // 键盘 JUNJA 键，仅用于特定语言输入法
        constant integer OSKEY_JUNJA = ($17)
        // 键盘 FINAL键，仅用于特定语言输入法
        constant integer OSKEY_FINAL = ($18)
        // 键盘 HANJA 键，仅用于朝鲜/韩语键盘
        constant integer OSKEY_HANJA = ($19)
        // 键盘 KANJI 键，仅用于日语键盘
        constant integer OSKEY_KANJI = ($19)
        // 键盘 ESC 键
