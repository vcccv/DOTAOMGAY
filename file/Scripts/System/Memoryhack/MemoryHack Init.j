...
//! import "Core API.j"
//! import "Constants API.j"
//! import "Widget API.j"
//! import "Ability&Buff API.j"
//! import "Unit API.j"

//! nocjass
library ZMHInit

    function Init_MemoryHackEx takes nothing returns nothing
        // Hook
        //call Init_MemHackCustomAbilityChargesHook()
        //call Init_MemoryHackMissileHook()
        //call Init_MemHackFinDamageHook()
        //call Init_MemoryHackPreDamageHook()
        //call Init_MemoryHackAbilityHook()
        //call Init_MemoryHackUnitHook()
        //call Init_MemoryHackJassHook()
        ////call Init_MemoryHackAbilityHandlerHook()
        ////call Init_MemHackAbilityOrderHook()
        //call Init_MemoryHackPlayerHook()
        //call Init_MemoryHackMessageHook()
    endfunction
    ...
    function Init_MemoryHack takes nothing returns nothing
        if PatchVersion != "" then
            ...
            //===============Optional API=============== // These APIs are for user to decide wherever they are needed or no, you are free to comment them out.
            ...
            call TimerStart(CreateTimer(), 1., false, function Init_MemoryHackEx)
            //=============================================
        else
    ...
    function InitMemoryHack takes nothing returns nothing
        ...
        //call TimerStart( CreateTimer( ), 0, false, function Init_MemoryHack )
        call Init_MemoryHack()
    endfunction
