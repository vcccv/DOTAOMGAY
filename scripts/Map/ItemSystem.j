...
//
    ...
    function SetRealItemPuckupFunc takes integer itemIndex, string func returns nothing
        set RealItemPickupCode[itemIndex] = C2I(MHGame_GetCode(func))
        call ThrowWarning(RealItemPickupCode[itemIndex] == 0, "ItemSystem", "SetRealItemPuckupFunc", "itemIndex", itemIndex, "func == 0")
    endfunction
    function SetRealItemDropFunc takes integer itemIndex, string func returns nothing
        set RealItemDropCode[itemIndex] = C2I(MHGame_GetCode(func))
        call ThrowWarning(RealItemDropCode[itemIndex] == 0, "ItemSystem", "SetRealItemDropFunc", "itemIndex", itemIndex, "func == 0")
    endfunction

    function SetRealItemFuncSimple takes integer itemIndex, string puckupFunc, string dropFunc returns nothing
        call SetRealItemPuckupFunc(itemIndex, puckupFunc)
        call SetRealItemDropFunc(itemIndex, dropFunc)
    endfunction
