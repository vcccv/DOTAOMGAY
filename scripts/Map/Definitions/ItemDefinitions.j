...
library ItemDefinitions requires ItemSystem, ItemStatus
    ...
    static if DEBUG_MODE then
        function ItemDefinttions_Debug takes nothing returns nothing
            local integer i 
            local integer sellDummyId
            local integer realId
            local integer sellCost
            local integer realCost

            set i = 1
            loop
                exitwhen i > MaxItemCount
                
                set sellDummyId = ItemSellDummyId[i]
                set realId      = ItemRealId[i]
                if sellDummyId != 0 and realId != 0 then
                    set sellCost = GetUnitGoldCostById(sellDummyId)
                    if MHItem_GetDefDataInt(realId, ITEM_DEF_DATA_USES) == 0 then
                        set realCost = GetItemGoldCostById(realId)
                    else
                        set realCost = GetItemGoldCostById(realId) / MHItem_GetDefDataInt(realId, ITEM_DEF_DATA_USES) * GetPerishableItemChargesByIndex(i)
                    endif
                    // 售卖马甲价格 == 实际物品价格
                    call ThrowError(RAbsBJ(sellCost - realCost) > 1, /*
                    */ "ItemSystem", "RegisterItem", GetObjectName(realId) + ">" + Id2String(realId), i, /*
                    */ "出售价格和买入价格不符，买入价格为:" + I2S(sellCost) + " 物品价格为：" + I2S(realCost))
                endif
    ...
    function ItemDefinitions_Init takes nothing returns nothing
        ...
        set Item_HandOfMidas                = RegisterItem('I06E', 'I06D', 0, 'I01T')
        set Item_HandOfMidas_CourierEdition = RegisterItem('I0NO', 'I0NN', 0, 'I0NP')
        ...
        // 自己的圣剑 Item_DivineRapier_Original
        set Item_DivineRapier_Original = RegisterItem('I0A2', 'I0A1', 0, 'I0BP')
        // 被人捡过的圣剑 Item_DivineRapier_Free
        set Item_DivineRapier_Free = RegisterItem('I0LI', 'I0LJ', 0, 'I0LK')
        ...
        // Item_FlyingCourier
        set Item_FlyingCourier = RegisterItem('I014', 'I01D', 0, 0)
        ...
        // Item_UrnOfShadows
        set Item_UrnOfShadows = RegisterItem('I0KX', 'I0KY', 0, 'I0KZ')
        ...
        call SaveInteger(HY, 'ITDB', RegisterItem(0, 0, 'h02W', 0), Item_HelmOfTheDominator)
        ...
        // Recipe_Bloodstone
        set Recipe_Bloodstone = RegisterItem('I0QQ', 'I0QN', 'h03T', 'I0QR')
        ...
        set CombinedIndex[CombineMaxIndex] = Item_HandOfMidas
        ...
        set CombinedIndex[CombineMaxIndex] = Item_HelmOfTheDominator
        ...
        set CombinedIndex[CombineMaxIndex] = Item_DivineRapier_Original
        ...
        set CombinedIndex[CombineMaxIndex] = Item_FlyingCourier
        ...
        set CombinedIndex[CombineMaxIndex] = Item_Bloodstone
        ...
        set CombinedIndex[CombineMaxIndex] = Item_ShivaGuard
        ...
        set CombinedIndex[CombineMaxIndex] = Item_UrnOfShadows
    ...
    globals
        ...
        integer ICV
        integer IDV
        integer Item_HandOfMidas
        integer Item_HandOfMidas_CourierEdition
        integer IHV
        integer IJV
        integer IKV
        integer ILV
        ...
        integer AQV
        integer Item_DivineRapier_Original
        integer Item_DivineRapier_Free
        integer AUV
        integer AWV
        integer AYV
        integer AZV
