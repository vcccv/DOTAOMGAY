...
library HeroAbilityLib requires AbilityCustomOrderId
    ...
    // 实际上应该优化 但没事还是别改
    private function RegisterPassiveSkill takes integer iRealSkill, integer iSpellBookSkill, integer iLearnedSkill, integer iSkillBuff, integer iShowSkill, integer iillusionUnitSkill returns nothing
    ...
    function GetSkillAghanimUpgradeIndexById takes integer id returns integer
        local integer i = 1
        loop
    ...
    function HeroSkillsAghanimScepterUpgrade_Init takes nothing returns nothing
        ...
        call RegisterAghanimUpgrade('A0KV', 'S3UG', 'A3UG', 0) // 群星坠落
