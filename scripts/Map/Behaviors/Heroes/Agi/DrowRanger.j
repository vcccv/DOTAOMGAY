...
scope DrowRanger
    ...
    //***************************************************************************
    globals
        constant integer SKILL_INDEX_TRUE_SHOT = GetHeroSKillIndexBySlot(HERO_INDEX_DROW_RANGE, 3)
    endglobals
    ...
    function MarksmanshipUpgradeLaunch takes unit u, unit u2, unit target, real damage returns nothing
        local trigger t = LaunchMissileDummyById(u2, target,'h30C', "MarksmanshipUpgradeMissileOnHit", 900, true, true)
        local integer h = GetHandleId(t)
