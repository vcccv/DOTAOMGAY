...
function DualBreathDamagedEvent takes nothing returns nothing
	local integer i = GetUnitAbilityLevel(DamageEvent.Source[Event.INDEX],'A0OB')
	if i > 0 and GetUnitAbilityLevel(DamageEvent.Source[Event.INDEX],'A3JI'-1 + i) == 0 then
		call UnitAddAbilityToTimed(DETarget,'A3JI'-1 + GetUnitAbilityLevel(DamageEvent.Source[Event.INDEX],'A0OB'), 1, 5,'B3J1')
	endif
endfunction
    ...
    */
    ...
    struct IcePath extends array
        ...
        private static method OnDelayEnd takes nothing returns nothing
            ...
            call DestroyTrigger(this.pathTrig)
