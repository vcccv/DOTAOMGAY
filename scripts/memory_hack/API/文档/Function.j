...
// 基本库
    ...
    // 获取护甲类型
    // @Tip：UNIT_ARMOUR_TYPE
    function MHUnit_GetArmourType takes unit u returns integer
    endfunction

    // 获取护甲类型
    // @param armour_type：护甲类型。UNIT_ARMOUR_TYPE
    function MHUnit_SetArmourType takes unit u, integer armour_type returns nothing
    endfunction
...
// 基本库
    ...
    // @param color_type：TEXT_COLOR
    // @param color：颜色
    function MHFrame_SetTextColor takes integer frame, integer color_type, integer color returns nothing
    endfunction
    ...
    // 设置文本标志
    // @param flag：TEXT_FLAG。bitset
    function MHFrame_SetTextFlag takes integer frame, integer flag returns nothing
    endfunction
    ...
    // 设置文本样式
    // @param flag：TEXT_STYLE。bitset
    function MHFrame_SetTextStyle takes integer frame, integer style returns nothing
    endfunction

    // 设置文本阴影偏移
    function MHFrame_SetTextShadowOff takes integer frame, real x, real y returns nothing
    endfunction
    ...
    // 添加边框
    // @param border_file：边框贴图路径
    // @param background_file：背景贴图路径
    // @param border_flag：BORDER_FLAG。bitset
    // @param border_size：边框尺寸
    // @param padding：填充尺寸
    // @param is_tile：边框平铺
...
// 基本库
    ...
    // 购买触发器添加的单位时 AbilityId = 'Asud'
    // 购买中立物品时        AbilityId = 'Asei'
    // 购买触发器添加的物品时 AbilityId = 'Asid'
