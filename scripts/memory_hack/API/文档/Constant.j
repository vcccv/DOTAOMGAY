...
// 事件ID：数据同步
// @Tip：同dz的同步
constant integer EVENT_ID_SYNC						        = 0x18
// 事件ID：游戏停止
// 异步事件
constant integer EVENT_ID_GAME_STOP					        = 0x19
// 事件ID：游戏退出
// 异步事件
constant integer EVENT_ID_GAME_EXIT					        = 0x1A
// 事件ID：任意玩家离开游戏
// @Tip：包括正常退出和掉线
// 异步事件
constant integer EVENT_ID_PLAYER_LEAVE				        = 0x1B
// 事件ID：鼠标进入Frame
// 异步事件
constant integer EVENT_ID_FRAME_MOUSE_ENTER			        = 0x1C
// 事件ID：鼠标离开Frame
// 异步事件
constant integer EVENT_ID_FRAME_MOUSE_LEAVE			        = 0x1D
// 事件ID：鼠标按下Frame
// @Tip：支持左右键和中键
// 异步事件
constant integer EVENT_ID_FRAME_MOUSE_DOWN			        = 0x1E
// 事件ID：鼠标弹起Frame
// @Tip：支持左右键和中键
// 异步事件
constant integer EVENT_ID_FRAME_MOUSE_UP				    = 0x1F
// 事件ID：鼠标点击Frame
// @Tip：支持左右键和中键
// 异步事件
constant integer EVENT_ID_FRAME_MOUSE_CLICK			        = 0x20
// 事件ID：鼠标双击Frame
// @Tip：支持左右键和中键
// 异步事件
constant integer EVENT_ID_FRAME_MOUSE_DOUBLE_CLICK	        = 0x21
// 事件ID：鼠标滚动Frame
// @Tip：即鼠标滚轮
// 异步事件
constant integer EVENT_ID_FRAME_MOUSE_SCROLL			    = 0x22
// 事件ID：本地玩家键盘弹起
// 异步事件
constant integer EVENT_ID_KEY_UP						    = 0x23
// 事件ID：本地玩家键盘按下
// 异步事件
constant integer EVENT_ID_KEY_DOWN					        = 0x24
// 事件ID：本地玩家键盘按住
// 异步事件
constant integer EVENT_ID_KEY_HOLD					        = 0x25
// 事件ID：本地玩家鼠标弹起
// 异步事件
constant integer EVENT_ID_MOUSE_UP					        = 0x26
// 事件ID：本地玩家鼠标按下
// 异步事件
constant integer EVENT_ID_MOUSE_DOWN					    = 0x27
// 事件ID：本地玩家鼠标滚动
// 异步事件
constant integer EVENT_ID_MOUSE_SCROLL				        = 0x28
// 事件ID：本地玩家鼠标移动
// 异步事件
constant integer EVENT_ID_MOUSE_MOVE					    = 0x29
// 事件ID：本地玩家按下目标指示器
// @Tip：目标指示器即攻击、技能目标、技能目标点等指示器
// 异步事件
constant integer EVENT_ID_TARGET_INDICATOR			        = 0x2A
// 事件ID：本地玩家调起目标指示器
// @Tip：目标指示器即攻击、技能目标、技能目标点等指示器
// 异步事件
...
// 事件ID：本地玩家帧绘制
// 异步事件
constant integer EVENT_ID_FRAME_TICK					    = 0x2F
// 事件ID：血条刷新
// @Tip：Hook了血条设置位置的一瞬间
// 异步事件
constant integer EVENT_ID_REFRESH_HPBAR				        = 0x30
// 事件ID：预渲染
// @Tip：在此事件中有血条更新, 可以作为血条刷新的替代
// 异步事件
constant integer EVENT_ID_PRERENDER					        = 0x31
// 事件ID：本地玩家改变窗口大小
// 异步事件
constant integer EVENT_ID_WINDOW_RESIZE				        = 0x32
...
// 游戏设置：声音驱动
// @Tip：0~2表示Dolby Surround/Miles Emulated 3D/Creative Labs EXA2
...
// 子动画类型 - 定身
constant integer SUBANIM_TYPE_ROOTED                        = 11
// 子动画类型 - 变形
constant integer SUBANIM_TYPE_ALTERNATE_EX                  = 12
// 子动画类型 - 循环
constant integer SUBANIM_TYPE_LOOPING                       = 13
// 子动画类型 - 猛击
constant integer SUBANIM_TYPE_SLAM                          = 14
// 子动画类型 - 投掷
constant integer SUBANIM_TYPE_THROW                         = 15
// 子动画类型 - 尖刺
constant integer SUBANIM_TYPE_SPIKED                        = 16
// 子动画类型 - 快速
constant integer SUBANIM_TYPE_FAST                          = 17
// 子动画类型 - 旋转
constant integer SUBANIM_TYPE_SPIN                          = 18
// 子动画类型 - 就绪
constant integer SUBANIM_TYPE_READY                         = 19
// 子动画类型 - 引导
constant integer SUBANIM_TYPE_CHANNEL                       = 20
// 子动画类型 - 防御
constant integer SUBANIM_TYPE_DEFEND                        = 21
// 子动画类型 - 庆祝胜利
constant integer SUBANIM_TYPE_VICTORY                       = 22
// 子动画类型 - 转身
constant integer SUBANIM_TYPE_TURN                          = 23
// 子动画类型 - 往左
constant integer SUBANIM_TYPE_LEFT                          = 24
// 子动画类型 - 往右
constant integer SUBANIM_TYPE_RIGHT                         = 25
// 子动画类型 - 火焰
constant integer SUBANIM_TYPE_FIRE                          = 26
// 子动画类型 - 血肉
constant integer SUBANIM_TYPE_FLESH                         = 27
// 子动画类型 - 命中
constant integer SUBANIM_TYPE_HIT                           = 28
// 子动画类型 - 受伤
constant integer SUBANIM_TYPE_WOUNDED                       = 29
// 子动画类型 - 发光
constant integer SUBANIM_TYPE_LIGHT                         = 30
// 子动画类型 - 温和
constant integer SUBANIM_TYPE_MODERATE                      = 31
// 子动画类型 - 严厉
constant integer SUBANIM_TYPE_SEVERE                        = 32
// 子动画类型 - 关键
constant integer SUBANIM_TYPE_CRITICAL                      = 33
// 子动画类型 - 完成
constant integer SUBANIM_TYPE_COMPLETE                      = 34
// 子动画类型 - 背运黄金
constant integer SUBANIM_TYPE_GOLD                          = 35
// 子动画类型 - 背运木材
constant integer SUBANIM_TYPE_LUMBER                        = 36
// 子动画类型 - 工作
constant integer SUBANIM_TYPE_WORK                          = 37
// 子动画类型 - 交谈
constant integer SUBANIM_TYPE_TALK                          = 38
// 子动画类型 - 第一
constant integer SUBANIM_TYPE_FIRST                         = 39
// 子动画类型 - 第二
constant integer SUBANIM_TYPE_SECOND                        = 40
// 子动画类型 - 第三
constant integer SUBANIM_TYPE_THIRD                         = 41
// 子动画类型 - 第四
constant integer SUBANIM_TYPE_FOURTH                        = 42
// 子动画类型 - 第五
constant integer SUBANIM_TYPE_FIFTH                         = 43
// 子动画类型 - 一
constant integer SUBANIM_TYPE_ONE                           = 44
// 子动画类型 - 二
constant integer SUBANIM_TYPE_TWO                           = 45
// 子动画类型 - 三
constant integer SUBANIM_TYPE_THREE                         = 46
// 子动画类型 - 四
constant integer SUBANIM_TYPE_FOUR                          = 47
// 子动画类型 - 五
constant integer SUBANIM_TYPE_FIVE                          = 48
// 子动画类型 - 小
constant integer SUBANIM_TYPE_SMALL                         = 49
// 子动画类型 - 中
constant integer SUBANIM_TYPE_MEDIUM                        = 50
// 子动画类型 - 大
constant integer SUBANIM_TYPE_LARGE                         = 51
// 子动画类型 - 升级
constant integer SUBANIM_TYPE_UPGRADE                       = 52
// 子动画类型 - 吸取
constant integer SUBANIM_TYPE_DRAIN                         = 53
// 子动画类型 - 吞噬
constant integer SUBANIM_TYPE_FILL                          = 54
// 子动画类型 - 闪电链
constant integer SUBANIM_TYPE_CHAINLIGHTNING                = 55
// 子动画类型 - 吃树
constant integer SUBANIM_TYPE_EATTREE                       = 56
// 子动画类型 - 呕吐
constant integer SUBANIM_TYPE_PUKE                          = 57
// 子动画类型 - 抽打
constant integer SUBANIM_TYPE_FLAIL                         = 58
// 子动画类型 - 关闭
constant integer SUBANIM_TYPE_OFF                           = 59
// 子动画类型 - 游泳
constant integer SUBANIM_TYPE_SWIM                          = 60
// 子动画类型 - 缠绕
constant integer SUBANIM_TYPE_ENTANGLE                      = 61
// 子动画类型 - 狂暴
constant integer SUBANIM_TYPE_BERSERK                       = 62
...
// 来自于物品
// @Tip：拥有该flag的技能不会被沉默/灵魂燃烧等技能沉默
constant integer ABILITY_FLAG_FROM_ITEM			            = 0x20
// 开启
